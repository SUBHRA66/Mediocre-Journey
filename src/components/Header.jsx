...
import { MenuOutlined, MoonOutlined, SunOutlined, HomeOutlined} from "@ant-design/icons";
...
export const Header = (props) => {
  ...
  return (
    <div className="header-container">
      ...
      <HomeOutlined onClick={props.onHomeClick} style = {{fontSize:"20px", fontWeight: "bold", margin: "5px", cursor: "pointer", paddingRight: "5px"}} />
      </div>
